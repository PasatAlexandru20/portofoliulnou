        ...
        <div className="z-30 basis-2/5 mt-12 md:mt-32">
          ...
          >
            <p className="text-6xl font-playfair z-10 text-center md:text-start ">
                ...
                {/* <hr style={{ width:120, paddingBottom:9}}/> */}
                {/* <span className=""><h1>Welcome</h1></span> */}
                  <p className="mt-10 mb-7 text-lg text-center md:text-start">
                  Hello! Nice to meet you. I`m a frond-end developer based in Bucharest,Romania. I am mainly focused on JavaScript, ReactJs, TailwindCss,
                        Passionate about pixel-perfect, intuitively implemented user interfaces`
                    </p>
            </p>
          </motion.div>
